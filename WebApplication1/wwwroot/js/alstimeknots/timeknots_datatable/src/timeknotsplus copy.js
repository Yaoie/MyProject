var TimeKnotsPlus = (() => {
    ...
    var drawLeftPanel = (leftPanel, width, height, cfg, dayLeft, percentPassed) => {
        ...
        frontArc.style.stroke = cfg.colorProgressCircularBar;
    ...
    var elementsOnMouseEvent = (elements, cfg, tip) => {
        elements.forEach((e, i) => {
            ...
            var txt = showCenterText ? e.querySelector("text") : null;
            var tick = showCenterText ? e.querySelector("svg.tick > g") : null;
